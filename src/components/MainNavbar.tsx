  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
        <span style={{ fontSize: '20px', fontWeight: 600, color: '#ff8533' }}>VideoPlayer</span>
        <Link
          to="/"
          style={{
        ...
        <Link
          to="/gallery"
          style={{
            color: location.pathname.startsWith('/gallery') ? '#ffbb66' : '#f8f9fa',
            textDecoration: 'none',
            ...
            {suggestions.map((video, index) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '10px',
                  border: 'none',
                  backgroundColor: highlightIndex === index ? '#2e2e2e' : 'transparent',
                  color: '#f8f9fa',
                  cursor: 'pointer',
                }}
